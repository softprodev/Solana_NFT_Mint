<script lang="ts">
  ...
  const TITLE = "SOL Hearts";
  const DESCRTIPTION = "SOL Hearts is a collection of 1,111 pfp hearts to give as a gift";
  const HEADER_TITLE = "WAGMImark.io/";
  const HEADER_LINK = "https://wagmimark.io/";
  // Your image or GIF needs to be in the /public folder for this to work
  const IMAGE_LINK = "/solhearts_head.png";
  /***********************************/
